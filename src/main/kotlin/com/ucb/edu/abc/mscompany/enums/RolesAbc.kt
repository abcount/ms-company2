...
enum class RolesAbc(
    ...
    CAN_ADD_EXCHANGE("Agregar comprobantes"),
    CAN_VIEW_EXCHANGE("Visualizar los comprobantes"),
    ...
    CAN_GENERATE_ANY_REPORTS("Generar reportes de cualquier tipo"),

    CAN_ADD_EXCHANGE("Agregar tasa de cambio"),

    CAN_ADD_PEOPLE("Invitar nuevos usuarios"),
